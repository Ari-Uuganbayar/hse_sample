...
import { useSignatureTypeContext } from "src/contexts/signatureTypeContext";
import * as API from "src/api/request";

import Detail from "src/pages/signatureType/detail";
...
const Index = () => {
  const { state, dispatch, type } = useSignatureTypeContext();
    ...
    <>
      ...
      <div className="min-h-[calc(100vh-64px)] bg-white text-xs border rounded-lg shadow">
        <div className="border-b p-3">
          <span className="font-semibold">"Гарын үсгийн төрөл" цонх</span>
        </div>
            ...
            <table className="w-full text-xs">
              <thead className="font-semibold">
                <tr>
                  ...
                  <th className="text-center p-1 border">Гарын үсгийн төрөл</th>
